          ...
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              $id = $_GET['idUp'];
                ...
                try{
                    $resulSel = $conect->prepare($select);
                    $resulSel ->bindParam(':id',$id,PDO::PARAM_INT);
                    $resulSel->execute();
                    //Mostrar os dados do BD no PHP
                    $contar = $resulSel->rowCount();
                    if($contar>0){
                        while($show = $resulSel->FETCH(PDO::FETCH_OBJ)){
                        ...
                        echo '<div class="alert alert-danger"> Não há contatos cadastrado!</div>';
                    }
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <div style="text-align: center;" class="card-body p-0">
                <img style="margin-top: 30px; width: 200px; border-radius: 100%"src="img/contato/<?php echo $fotoCont; ?>">
                <h1><?php echo $nomeCont; ?><h1>
                <h2><?php echo $foneCont; ?></h2>
                <h3 style="margin-bottom: 70px"><?php echo $emailCont; ?></h3>
              </div>
              <!-- /.card-body -->
            </div>
          </div>
